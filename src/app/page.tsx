    ...
    return (
        <div className="min-h-screen font-sans text-ink selection:bg-teal/20 bg-fixed" style={{
            ...
            <main className="max-w-7xl mx-auto px-6 pb-20 pt-8">
                ...
                {/* Hero / Upsell Section */}
                {!isPro && !loading && (
                    <div className="mb-16 rounded-3xl p-8 md:p-10 flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden shadow-2xl shadow-teal/20 bg-gradient-to-br from-teal to-[#1F6666]">
                        {/* Background Pattern */}
                        ...
                        <div className="relative z-10 max-w-xl">
                            <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-md text-white px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider mb-4 border border-white/10">
                                <Sparkles size={14} /> Pro Membership
                            </div>
                            <h2 className="text-3xl md:text-4xl font-bold mb-3 text-white">
                                Unlock the Full Library
                            </h2>
                            <p className="text-lg text-white/80 leading-relaxed">
                                Get unlimited access to all premium mockups, instant generation, and exclusive templates.
                            </p>
                        </div>
                        <div className="relative z-10 flex-shrink-0 w-full md:w-auto">
                            <Link href="/pricing" className="group bg-white text-teal font-bold text-lg px-8 py-4 rounded-xl hover:shadow-lg hover:shadow-white/20 hover:-translate-y-0.5 transition-all flex items-center justify-center gap-2 w-full md:w-auto">
