        ...
        <div className="max-w-6xl mx-auto space-y-8">
            ...
            {showGuestSignupPrompt && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                    <div className="absolute inset-0 bg-black/40 backdrop-blur-sm" onClick={() => setShowGuestSignupPrompt(false)} />
                    <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md p-8 relative z-10 animate-in zoom-in-95 duration-300">
                        ...
                        <div className="text-center">
                            <div className="w-16 h-16 bg-gradient-to-br from-teal to-emerald-500 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg shadow-teal/30">
                                <Sparkles size={32} className="text-white" />
                            </div>

                            <h2 className="text-2xl font-bold text-ink mb-2">Love Your Mockup?</h2>
                            <p className="text-ink/60 mb-6">
                                Sign up to <strong className="text-ink">save it to your dashboard</strong> and get <strong className="text-teal">5 free credits</strong> to create more!
                            </p>
                            ...
                            <button
                                ...
                                className="w-full flex items-center justify-center gap-3 bg-ink text-white font-bold py-4 px-6 rounded-xl hover:bg-ink/90 transition-all shadow-lg shadow-ink/20 mb-4"
                            >
                            ...
                            <p className="text-xs text-ink/30 mt-6">
                                Your mockup will still be here after you sign up
                            </p>
                        </div>
                    </div>
                </div>
